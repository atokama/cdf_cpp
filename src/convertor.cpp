...
/*
    void Convertor::convert(const path &source, const path &dest) {
        ...
        TXTFile txt{dest, "\t", 2};
        std::function<
                void(const map<string, sh_ptr<Variable>> &, long, TXTFile &)
        > extr_ptr{nullptr};
    ...
    void Convertor::extract_type1(const map<string, sh_ptr<Variable>> &vars, long num_elements, TXTFile &txt) {
    ...
    void Convertor::extract_type2(const map<string, sh_ptr<Variable>> &vars, long num_elements, TXTFile &txt) {
    ...
    void Convertor::extract_type3(const map<string, sh_ptr<Variable>> &vars, long num_elements, TXTFile &txt) {
